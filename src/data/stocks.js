...
export const ISU_INVESTMENT = 8_000_000

export const INITIAL_INVESTMENT = SDI_INVESTMENT + SAMSUNG_INVESTMENT + TESLA_INVESTMENT + HANJUNG_INVESTMENT + SEOJIN_INVESTMENT + ECOPRO_INVESTMENT + ISU_INVESTMENT + 4100000
...
export const STOCK_LIST = [
    ...
    {name: '이수스페셜티케미컬', symbol: '457190', quantity: 90, market: 'KR', type: 'KS', base: ISU_INVESTMENT},
