    ...
    <div className="container bg-gray-100 p-5 md:p-10 min-h-screen">
      ...
      {exchangeRate > 0 && (
        <div className="exchange-rate">
          💱 환율: $1 = ₩{exchangeRate.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
        </div>
      )}
              ...
              {exchangeRate > 0 && (() => {
                ...
                return (
                  <>
                    ...
                    <div className="mt-2">
                      전체 총 평가금액: ₩{totalValue.toLocaleString(undefined, { maximumFractionDigits: 0 })}
                    </div>
                    <div className={`mt-2 text-lg ${profit >= 0 ? 'text-red-700' : 'text-blue-700'}`}>
                      평가 손익: {profit >= 0 ? '+' : ''}₩{profit.toLocaleString(undefined, { maximumFractionDigits: 0 })}
